...
const SITEMAP = [
  ...
  {
    title: "Sections",
    links: ["Services", "Features", "Get App", "FAQ"],
  },
];
...
export function Footer() {
  return (
    <div className="bg-[#9BBEC8]">
      <footer className="relative max-w-screen-xl mx-auto text-inherit">
        <div className="mx-auto w-full max-w-7xl px-8">
          <div className="mx-auto grid max-w-screen-lg grid-cols-1 gap-8 py-12 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="flex w-full flex-col items-center justify-center border-t border-inherit py-4 md:flex-row md:justify-between">
            ...
            >
              &copy; {currentYear}{" "}
              <a href="https://material-tailwind.com/">RideWave</a>. All Rights
              Reserved.
            </Typography>
