...
export const Skeleton = () => {
  return (
    <div
      role="status"
      className="max-w-sm p-4 border bg-[#9BBEC8] border-[#9BBEC8] rounded shadow animate-pulse md:p-6"
    >
      ...
      <div className="flex items-center mt-4 space-x-3">
        ...
        <Rating unratedColor="gray" ratedColor="gray" readonly value={4} />
      </div>
      ...
      <div>
        <div className="bg-gray-200 mx-auto w-28 rounded-lg h-10"></div>
      </div>
